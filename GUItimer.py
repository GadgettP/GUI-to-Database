...
dayEntry= Entry(app, width=3, font=("Arial",18,""),
				textvariable=day)
dayEntry.place(x=30,y=20)

hourEntry= Entry(app, width=3, font=("Arial",18,""),
				textvariable=hour)
...
def submit():
	try:
		...
		# stored in here :temp
		temp = int(day.get())*86400 + int(hour.get())*3600 + int(minute.get())*60 + int(second.get())
	except:
